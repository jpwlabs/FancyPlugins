...
ARTIFACTS = {
    "FancyNpcs": ROOT / "plugins/fancynpcs-v2/build/libs/FancyNpcs-2.9.2.341-jpw.3.jar",
    "FancyHolograms": ROOT / "plugins/fancyholograms-v2/build/libs/FancyHolograms-2.9.1.180-jpw.3.jar",
    "FancyDialogs": ROOT / "plugins/fancydialogs/build/libs/FancyDialogs-1.1.2-jpw.3.jar",
}
FORBIDDEN = (
